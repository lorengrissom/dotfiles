...
export PATH=$HOME/bin:$HOME/.local/bin:/usr/local/go/bin:/usr/local/bin:/usr/bin:$HOME/nodejs/bin:$PATH
...
alias ls='exa --icons -a --group --group-directories-first'
alias la='exa --icons -a --group --group-directories-first --long'
# alias w3m='w3m -sixel'
source $HOME/.config/zsh/alais.text
...
# lua-lang path
export PATH="$PATH:/home/loren/.local/share/nvim/mason/bin"
export PATH="$PATH:/home/loren/.luarocks/bin"
